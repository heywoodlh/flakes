    ...
    in {
      packages = {
        ...
        dev = mkKubeDrv "dev" {
          ...
          namespace = "default";
          replicas = 1;
          image = "docker.io/heywoodlh/dev:2025_02_snapshot";
        };
        ...
        grafana = mkKubeDrv "grafana" {
          ...
          namespace = "monitoring";
          image = "docker.io/grafana/grafana:10.4.16";
        ...
        miniflux = mkKubeDrv "miniflux" {
          ...
          namespace = "default";
          image = "docker.io/miniflux/miniflux:2.2.6";
        ...
        open-webui = mkKubeDrv "open-webui" {
          ...
          namespace = "machine-learning";
          webui_image = "ghcr.io/open-webui/open-webui:0.5.16";
        };
        ...
        tailscale-operator = mkKubeDrv "tailscale-operator" {
          ...
          operator_image = "docker.io/tailscale/k8s-operator:v1.80.0";
          proxy_image = "docker.io/tailscale/tailscale:v1.80.0";
          replicas = 1;
        };
